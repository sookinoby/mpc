...
// Evaluate the slope of polynomial.
// Returns the derivate. dy/dx for a third order polynomial
...
//          }
                    ...
                    */
                    ...
                    // not sure why -steer value
                    msgJson["steering_angle"] = -steer_value ;
                    msgJson["throttle"] = throttle_value;
//                    msgJson["steering_angle"] = a;
//                    msgJson["throttle"] = b;
                    int N = 15;
                    ...
                    // next_x_vals = {-3.0,3.0,5.0};
                    //  next_y_vals = {2.0,2.0,2.0};
                    cout<<psi<<",";
                    //cout<<py;
