...
```
I discussed in the forum and found out this solution. I am not sure why we are using -psi, since I am not sure how the map coordinate is described in the simulator. 


## Model Predictive Control with Latency

To accomodate the delay, I update the state of car with current steering angle and move it forward by 100 milliseconds 
```python
